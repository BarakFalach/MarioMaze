...
public void onZoom(boolean zoomIn) {//if Zoomin true do zoomin, zoomin=false -> zoom oUt
    ...
    public String getImageSolutionPath(){return imageSolutionPath.get();}

    public StringProperty imageSolutionPathProperty(){return imageSolutionPath;}

    public void setImageSolutionPath(String imageSolutionPath){this.imageSolutionPath.set(imageSolutionPath);}
...
if( maze!=null)
    {
        ...
        double x,y;
        //Draw Maze
        //drawFrame(cellHeight,cellWidth,row,col,graphicsContext);
